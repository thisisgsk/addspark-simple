...
const MemberCard = ({ imageUrl, name, designation }) => {
    return (
        <div className="w-[90%] flex flex-col mx-auto relative text-white">
            ...
            <h4 className="bg-customprimary p-2 px-4 absolute top-0 right-0">{designation}</h4>
            <h3 className="bg-customsecondary text-2xl p-2 px-4 absolute bottom-0 left-0">{name}</h3>
        </div >
    );
};
